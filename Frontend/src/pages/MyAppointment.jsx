...
const MyAppointments = () => {
 ...
 const initPay = (order) => {
  ...
  const options = {
    ...
    order_id: order.id,   // ✅ ONLY THIS REQUIRED

    handler: async (response) => {
      console.log("PAYMENT RESPONSE:", response) // 👈 ADD THIS
  ...
  return (
    <>
      <style>{`
        ...
        @keyframes ma-heart-spin-in {
          from{transform:scale(0) rotate(-180deg); opacity:0;}
          to  {transform:scale(1) rotate(0deg); opacity:var(--op,0.08);}
        }
        ...
        .ma-ring-3 {
          width:130px; height:130px; top:48%; right:12%;
          border:1px solid rgba(186,230,253,0.4);
          animation:ma-ring-cw 20s linear infinite;
        }
        .ma-ring-4 {
          width:80px; height:80px; top:30%; left:18%;
          border:1px solid rgba(196,181,253,0.3);
          animation:ma-ring-ccw 15s linear infinite;
        }
        ...
        .ma-pr {
          ...
          animation:ma-ring-pulse 4.5s ease-out infinite;
        }
        ...
        .ma-sheart {
          ...
          animation:ma-heart-beat 1.15s ease-in-out infinite;
        }
        ...
        .ma-hero {
          ...
          animation:ma-slide-up 0.7s ease both;
        }
        .ma-eyebrow {
        ...
        .ma-eye-dot {
          ...
          background:#7C3AED;
          animation:ma-twinkle 1.8s ease-in-out infinite;
        }
        .ma-eye-txt {
          ...
          animation:ma-shimmer-txt 3.5s linear infinite;
        }
        .ma-page-title {
          font-family:'Playfair Display',serif;
          font-size:46px; font-weight:800; color:#1E1B4B;
        ...
        .ma-page-sub {
          font-size:15px; font-weight:300; color:#64748B; line-height:1.7;
        }
        ...
        .ma-loader-h {
          ...
          animation:ma-loader-pulse 1.2s ease-in-out infinite;
        }
        ...
        .ma-empty-heart {
          width:80px; height:72px; margin:0 auto 20px;
          animation:ma-heart-beat 1.2s ease-in-out infinite;
          opacity:0.4;
        }
        .ma-empty-title {
          font-family:'Playfair Display',serif;
        ...
        .ma-card::before {
          ...
          animation:ma-card-shine 6s ease-in-out infinite;
          pointer-events:none;
        }
        /* Hover gradient fill */
        .ma-card::after {
        ...
        /* Doc image */
        .ma-doc-img {
          width:106px; height:118px; flex-shrink:0;
        ...
        .ma-actions {
          ...
          justify-content:center; flex-shrink:0; min-width:148px;
        }
        .ma-btn {
        ...
        .ma-btn-rzp:hover { border-color:rgba(99,102,241,0.4); transform:translateY(-1px); }
        .ma-btn-rzp img { max-height:18px; max-width:80px; }

        .ma-btn-paid {
          background:rgba(5,150,105,0.08); color:#065F46;
          border:1.5px solid rgba(5,150,105,0.2); cursor:default;
        }
        .ma-btn-done {
          background:rgba(14,165,233,0.08); color:#0369A1;
          border:1.5px solid rgba(14,165,233,0.2); cursor:default;
        }
        .ma-btn-cancel {
        ...
        .ma-btn-cancelled {
          ...
          border:1.5px solid rgba(239,68,68,0.3); cursor:default;
        }
      ...
      <div className="ma-bg" aria-hidden="true">
        ...
        <svg className="ma-ecg-svg ma-ecg-bot" viewBox="0 0 1440 60" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
          <path d="M0,30 L100,30 L115,30 L122,8 L130,52 L136,0 L148,60 L156,30 L230,30 L310,30 L318,16 L326,44 L334,30 L430,30 L465,30 L472,10 L480,50 L486,2 L498,58 L506,30 L584,30 L665,30 L672,18 L680,42 L688,30 L775,30 L815,30 L822,8 L830,52 L836,0 L848,60 L856,30 L936,30 L1018,30 L1025,16 L1033,44 L1041,30 L1138,30 L1178,30 L1185,10 L1193,50 L1199,2 L1211,58 L1219,30 L1440,30"
            fill="none" stroke="url(#ecgg1)" strokeWidth="2.2"
        ...
        <svg className="ma-ecg-svg ma-ecg-top" viewBox="0 0 1440 60" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
          <path d="M0,30 L170,30 L178,30 L184,13 L191,47 L195,3 L205,57 L211,30 L295,30 L390,30 L397,19 L404,41 L411,30 L510,30 L552,30 L558,11 L565,49 L570,2 L580,58 L586,30 L688,30 L770,30 L776,17 L783,43 L790,30 L888,30 L950,30 L956,12 L963,48 L968,3 L978,57 L984,30 L1075,30 L1155,30 L1161,19 L1168,41 L1175,30 L1295,30 L1440,30"
            fill="none" stroke="url(#ecgg2)" strokeWidth="1.6"
        ...
        <svg className="ma-ecg-svg ma-ecg-mid" viewBox="0 0 1440 60" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
          <path d="M0,30 L200,30 L208,22 L216,38 L224,30 L340,30 L380,30 L386,14 L393,46 L398,4 L408,56 L414,30 L520,30 L620,30 L626,21 L633,39 L640,30 L760,30 L820,30 L826,13 L833,47 L838,3 L848,57 L854,30 L970,30 L1060,30 L1066,22 L1073,38 L1080,30 L1200,30 L1440,30"
            fill="none" stroke="url(#ecgg3)" strokeWidth="1.2"
        ...
        {/* Static beating hearts */}
        {[
          {cls:'ma-sh1',c1:'#7C3AED',c2:'#4F46E5'},
          {cls:'ma-sh2',c1:'#EC4899',c2:'#F472B6'},
          {cls:'ma-sh3',c1:'#4F46E5',c2:'#818CF8'},
          {cls:'ma-sh4',c1:'#7C3AED',c2:'#EC4899'},
          {cls:'ma-sh5',c1:'#A855F7',c2:'#EC4899'},
          {cls:'ma-sh6',c1:'#4F46E5',c2:'#7C3AED'},
        ].map((h,i)=>(
        ...
        {/* Floating rising hearts */}
        {[
          {cls:'ma-fh1',color:'#7C3AED',size:30},
          {cls:'ma-fh2',color:'#EC4899',size:24},
          {cls:'ma-fh3',color:'#4F46E5',size:28},
          {cls:'ma-fh4',color:'#A855F7',size:22},
          {cls:'ma-fh5',color:'#F472B6',size:18},
        ].map((h,i)=>(
        ...
        <div className="ma-orbit-center ma-oc1">
          {[
            {dur:'12s',del:'0s',op:0.1,rad:'90px',c:'#7C3AED',sz:14},
            {dur:'18s',del:'6s', op:0.08,rad:'90px',c:'#EC4899',sz:10},
          ].map((o,i)=>(
        ...
        <div className="ma-orbit-center ma-oc2">
          {[
            {dur:'16s',del:'0s',op:0.09,rad:'70px',c:'#818CF8',sz:12},
            {dur:'22s',del:'8s', op:0.07,rad:'70px',c:'#F472B6',sz:9},
          ].map((o,i)=>(
            <div key={i} className="ma-orbit-heart" style={{'--dur':o.dur,'--del':o.del,'--op':o.op,'--radius':o.rad}}>
              <svg width={o.sz} height={o.sz*0.9} viewBox="0 0 100 90" xmlns="http://www.w3.org/2000/svg">
                <path d="M50,80 C30,65 5,50 5,28 C5,14 16,5 28,5 C36,5 44,9 50,16 C56,9 64,5 72,5 C84,5 95,14 95,28 C95,50 70,65 50,80Z" fill={o.c}/>
        ...
        {/* Medical crosses */}
        <div className="ma-cross ma-cross-1">
          <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            <rect x="12" y="2" width="8" height="28" rx="3" fill="rgba(167,139,250,0.28)"/>
            <rect x="2" y="12" width="28" height="8" rx="3" fill="rgba(167,139,250,0.28)"/>
          </svg>
        </div>
        <div className="ma-cross ma-cross-2">
          <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            <rect x="12" y="2" width="8" height="28" rx="3" fill="rgba(244,114,182,0.22)"/>
            <rect x="2" y="12" width="28" height="8" rx="3" fill="rgba(244,114,182,0.22)"/>
          </svg>
        </div>
        <div className="ma-cross ma-cross-3">
          <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            <rect x="12" y="2" width="8" height="28" rx="3" fill="rgba(129,140,248,0.2)"/>
            <rect x="2" y="12" width="28" height="8" rx="3" fill="rgba(129,140,248,0.2)"/>
          </svg>
        </div>

        {/* Twinkle particles */}
        {[
          {t:'20%',l:'30%',w:6,dur:'2.5s',del:'0s'},
          {t:'35%',r:'22%',w:4,dur:'3.5s',del:'1s'},
          {t:'55%',l:'14%',w:5,dur:'2.1s',del:'0.5s'},
          {t:'72%',r:'38%',w:4,dur:'4s',  del:'1.8s'},
          {t:'14%',l:'54%',w:7,dur:'3.1s',del:'0.8s'},
          {t:'82%',l:'62%',w:3,dur:'2.8s',del:'2.2s'},
          {t:'42%',r:'6%', w:5,dur:'3.6s',del:'1.4s'},
          {t:'65%',l:'32%',w:4,dur:'2.2s',del:'0.3s'},
        ].map((s,i)=>(
          <div key={i} className="ma-twinkle" style={{
            ...
            {!loading && appointments.length > 0 && (
              <div className="ma-count-strip">
                <div className="ma-count-pill">
                  ...
                  <div>
                    <div className="ma-count-pill-num">{appointments.length}</div>
                    <div className="ma-count-pill-lbl">Total</div>
                  </div>
                </div>
                <div className="ma-count-pill">
                  <div className="ma-count-pill-icon" style={{background:'rgba(5,150,105,0.1)'}}>✅</div>
                  <div>
                    <div className="ma-count-pill-num">{appointments.filter(a=>a.payment&&!a.isCompleted&&!a.cancelled).length}</div>
                    <div className="ma-count-pill-lbl">Paid</div>
                  </div>
                </div>
                <div className="ma-count-pill">
                  <div className="ma-count-pill-icon" style={{background:'rgba(14,165,233,0.1)'}}>🎯</div>
                  <div>
                    <div className="ma-count-pill-num">{appointments.filter(a=>a.isCompleted).length}</div>
                    <div className="ma-count-pill-lbl">Done</div>
                  </div>
                </div>
              </div>
            )}
          ...
          {!loading && appointments.length === 0 && (
            <div className="ma-empty">
              <div className="ma-empty-heart">
                <svg viewBox="0 0 100 90" xmlns="http://www.w3.org/2000/svg">
                  <defs>
                    <linearGradient id="empty-hg" x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                return (
                  <div key={index} className="ma-card">
                    ...
                    <div className="ma-actions">
                      ...
                      {isActive && payment === item._id && (
                        <button className="ma-btn ma-btn-rzp" onClick={()=>appointmentRazorpay(item._id)}>
